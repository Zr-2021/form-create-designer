            ...
            <ElContainer style="height: 100%;">
                ...
                <ElContainer class="_fc-m">
                    <el-header class="_fc-m-tools" height="45">
                        ...
                        <el-button type="success" plain round size="small"
                                   @click="saveFc"><i class="fc-icon icon-save"></i> {{ t('designer.save') }}
                        </el-button>
                        <el-popconfirm
                ...
                <ElDialog v-model="preview.state" width="800px" append-to-body>
                    <ViewForm :rule="preview.rule" :option="preview.option" v-if="preview.state" @submit="saveFc"></ViewForm>
                </ElDialog>
            </ElContainer>
        </ElMain>
    </ElContainer>
    ...
    setup(props) {
        ...
        const methods = {
            ...
            saveAsFc() {
                ...
                fetch('/gwdi/formCreateSaveAsServlet', {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
